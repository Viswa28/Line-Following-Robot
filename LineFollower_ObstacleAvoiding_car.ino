...
//website : www.procreativehub.com

#include<NewPing.h>

int ENA = 5;  //ENA connected to digital pin 5
int ENB = 10;  //ENB connected to digital pin 9
int MOTOR_A1 = 6; // MOTOR_A1 connected to digital pin 4
int MOTOR_A2 = 7; // MOTOR_A2 connected to digital pin 5
int MOTOR_B1 = 8; // MOTOR_B1 connected to digital pin 6
int MOTOR_B2 = 9; // MOTOR_B2 connected to digital pin 7
